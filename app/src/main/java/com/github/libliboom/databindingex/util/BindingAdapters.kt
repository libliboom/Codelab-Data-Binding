...
import com.github.libliboom.databindingex.data.Popularity
...
private fun getAssociatedColor(popularity: Popularity, context: Context): Int {
    return when (popularity) {
        Popularity.NORMAL -> getThemeAttrs(context).getColor(0, 0x000000)
...
private fun getThemeAttrs(context: Context): TypedArray {
    return context.theme.obtainStyledAttributes(intArrayOf(android.R.attr.colorForeground))
}
